...
Subpages can contain Switch, Action, Trigger, Sensor, Slider, Cover, Climate, Garage Door, Date, World Clock, Weather, and Weather Forecast cards. They cannot contain another Subpage card.
...
- Read-only cards such as Sensor, Date, World Clock, Weather, and Weather Forecast do not affect the Subpage card state.
